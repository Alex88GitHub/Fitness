...
var _initTabs = require("./vendor/init-tabs.js");
require("./modules/select-ticket.js");
// ---------------------------------
...
},{"./modules/form-validate/form":3,"./modules/modals/init-modals":9,"./modules/select-ticket.js":11,"./utils/ios-vh-fix":14,"./vendor/init-accordion.js":17,"./vendor/init-tabs.js":18}],2:[function(require,module,exports){
"use strict";
...
priceWrapperElement.forEach(function (element) {
  var style = getComputedStyle(element, ':before').content;
  console.log(style);
});
