...
},{"./modules/form":9,"./modules/form-validate/form":3,"./modules/init-sliders":10,"./modules/modals/init-modals":11,"./modules/render-ticket":13,"./modules/video":15,"./utils/ios-vh-fix":18,"./vendor/init-accordion":21,"./vendor/init-tabs":22}],2:[function(require,module,exports){
"use strict";
...
var _pristine = _interopRequireDefault(require("../vendor/pristine"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var VALID_NAME_SYMBOLS = /^[a-zа-яё]{1,}$/i;
var VALID_PHONE_SYMBOLS = /^[0-9]{1,}$/;
// const MIN_COUNT_SYMBOLS = 1;
var VALID_NAME_ERROR_MESSAGE = 'Введите имя кириллицей или латиницей';
var VALID_PHONE_ERROR_MESSAGE = 'Введите цифры номера без пробелов и спецсимволов';
...
var inputPhoneElement = formElement.querySelector('.input[name=phone]');
var labelNameElement = inputNameElement.closest('label');
var labelPhoneElement = inputPhoneElement.closest('label');
var pristine = new _pristine.default(formElement, {
  classTo: 'form__label',
...
var hasValidName = function hasValidName(value) {
  var isValid = VALID_NAME_SYMBOLS.test(value);
  if (!isValid) {
...
pristine.addValidator(inputNameElement, hasValidName, VALID_NAME_ERROR_MESSAGE);
var hasValidPhone = function hasValidPhone(value) {
  var isValid = VALID_PHONE_SYMBOLS.test(value);
  if (!isValid) {
...
pristine.addValidator(inputPhoneElement, hasValidPhone, VALID_PHONE_ERROR_MESSAGE);
...
},{"../vendor/pristine":23}],10:[function(require,module,exports){
"use strict";
...
var initSliders = exports.initSliders = function initSliders() {
  (0, _sliders.jurySlider)();
  (0, _sliders.reviewSlider)();
};

},{"./sliders":14}],11:[function(require,module,exports){
"use strict";
...
var period = document.querySelectorAll('.time-list-item');
var priceValueElement = document.querySelectorAll('.visits-item__price-title');
var typeTicketElement = document.querySelectorAll('.visits-item__title');
var priceWrapperElement = document.querySelectorAll('.visits-item__price-wrapper');
var priceBackgroundElement = document.querySelectorAll('.visits-item__background');
var pricePeriod = {
  withTrainer: {
    oneMonth: '5000',
    sixMonth: '30000',
...
var getPrice = exports.getPrice = function getPrice(element) {
  if (element === '1 месяц') {
    typeTicketElement.forEach(function (typeElement, index) {
...
var onPeriodClickHandler = function onPeriodClickHandler(evt) {
...
exports.reviewSlider = exports.jurySlider = exports.initSliders = void 0;
var jurySlider = exports.jurySlider = function jurySlider() {
  var sliderWrapper = document.querySelector('[data-slider="jury-slider"]');
  var buttonPrev = document.querySelector('[data-jury-button="prev-button"]');
  var buttonNext = document.querySelector('[data-jury-button="next-button"]');
...
var reviewSlider = exports.reviewSlider = function reviewSlider() {
  var sliderWrapper = document.querySelector('[data-slider="reviews-slider"]');
  var buttonPrev = document.querySelector('[data-reviews-button="prev-button"]');
  var buttonNext = document.querySelector('[data-reviews-button="next-button"]');
  return new window.Swiper(sliderWrapper, {
    direction: 'horizontal',
    effect: 'fade',
    speed: 100,
...
var setupVideo = exports.setupVideo = function setupVideo() {
  var video = document.querySelector('.training-gym__video');
  var link = video.querySelector('.training-gym__video-link');
  var button = video.querySelector('.training-gym__button');
...
},{"./tabs":24}],23:[function(require,module,exports){
"use strict";
